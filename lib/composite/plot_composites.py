...
for filename in os.listdir(filepath):
  if filename.startswith("wrfout"):
    ...
    comp_lib.print_comp_for_timestamp(wrf_data, timestamp)

    # plot rainsum and pressure
    rain_lib.print_total_rainsum_for_timestamp(wrf_data, timestamp)

    # plot cape and pressure
    thunderstorm_lib.print_cape_for_timestamp(wrf_data, timestamp)
